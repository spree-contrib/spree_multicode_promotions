FactoryBot.define do
  ...
  factory :multicode_promotion, class: Spree::Promotion do
    name 'Promo'
    ...
    factory :multicode_promotion_with_item_adjustment, traits: [:with_line_item_adjustment]
    ...
    factory :multicode_promotion_with_order_adjustment, traits: [:with_order_adjustment]
    ...
    factory :multicode_promotion_with_item_total_rule, traits: [:with_item_total_rule]
  end
end
